...
#define KIND_GAME_FAIL      9
#define KIND_GAME_CLEAR     10
#define KIND_PLAYER_DEAD    11
...
#define MAX_PLAYER_DEAD_ANIMATION_SEQUENCE_X 3
#define MAX_PLAYER_DEAD_ANIMATION_SEQUENCE_Y 1
